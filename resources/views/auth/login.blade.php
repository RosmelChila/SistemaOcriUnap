<x-guest-layout>
    <div class="flex flex-col min-h-screen font-bunny dark:bg-gray-900">
        <header
            ...
            <div
                ...
                <a class="text-gray-800 dark:text-gray-200" href="/">
        ...
        <main class="flex-1 lg:mt-20">
            <div
                ...
                <div class="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-gray-200 dark:bg-gray-900 ">
                    <h2 class="text-2xl font-semibold text-center text-gray-700 dark:text-white">OCRI - UNA - PUNO
                    </h2>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a href="#"
                            class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">Llene
                            tus credenciales</a>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="email" id="email" type="email" name="email" :value=""
                                required autofocus
                                class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 ">
                        </div>
                        <div class="mt-4 bg-red"></div>
                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200" for="password"
                            value="{{ __('Password') }}">Contraseña
                            <span>*</span></label>
                    ...
                    <div class="flex items-center justify-between mt-4"><span
                            class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span> <a href="/register"
                            class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">Soporte</a> <span
                            class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span></div>
                </div>
            </div>
        </main>
        ...
        {{-- para footer --}}
            <div class="bg-gray-100 dark:bg-gray-800">
                <div
                    ...
                    <p class="text-sm text-center text-gray-500 dark:text-gray-300">© 2022 Derechos reservados. Oficina de

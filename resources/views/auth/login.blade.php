                        ...
                        <div class="form-control">
                            <label for="remember_me" class="label cursor-pointer">
                                <input id="remember_me" type="checkbox"
                                    class="checkbox checkbox-info checkbox-sm dark:checkbox dark:checkbox-sm "
                                    name="remember" />
        ...
        <main class="flex-1 lg:mt-20">
            <div
                ...
                <div class="items-center hidden lg:flex lg:w-1/2">
                    <img src="https://cdn.pixabay.com/photo/2017/11/06/17/07/cooperate-2924261_960_720.png"
                        alt="" class="p-10">
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-4">
                            <label class="block" for="email" value="{{ __('Email') }}">
                                ...
                                <input type="email" id="email" name="email" placeholder="Email"
                                    :value=""
                                    class="input input-info dark:input w-full bg-zinc-100 dark:bg-zinc-800" />
                            </label>
                        </div>
                        <div class="mt-4">
                            <label class="block" for="password" value="{{ __('password') }}">

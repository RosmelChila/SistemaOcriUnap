<div>
    <div class="container grid grid-cols-2 gap-4 mx-auto px-6">
        ...
        <div class="flex justify-end my-2">
            <button wire:click='genpdf' class="shadow-lg btn btn-info btn-xs text-zinc-100"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mx-2">

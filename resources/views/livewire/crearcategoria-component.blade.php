<div class="mt-4">
    <div wire:click="$set('open',true)"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
          ...
          <span class="label-text text-zinc-700 dark:text-zinc-400 font-light text-sm px-4">Categoria</span>
    </div>
                ...
                <form action="">
                    <div class="grid grid-flow-col dark:bg-zinc-900 rounded-lg py-4">
                        <div class="px-4 grid content-center col-span-1">
                            <label class="label">
                                <span class="label-text text-zinc-900 dark:text-zinc-100">Categoria</span>
                            </label>

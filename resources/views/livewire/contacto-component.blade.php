<div class="px-10 bg-white dark:bg-zinc-900 font-light" id="contacto">
    <section
        class="h-screen relative z-10 overflow-hidden text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-900 py-20 lg:py-[120px] flex">
        <div class="container mx-auto ">
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <span class="text-sky-500 dark:text-yellow-500 mb-4 block text-base font-semibold">
                            Información
                        </span>
                        <h2
                        ...
                        <p class="text-body-color mb-9 leading-relaxed text-xs">
                            ...
                            Puno, nuestra labor se enmarca en recibir, revisar, corregir, elaborar,
                            proponer
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                                class="bg-sky-500 dark:text-yellow-500 text-sky-500  mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-xs">---</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-body-color text-xs">ocni@unap.pe</p>
                                <p class="text-body-color text-xs">ocriunapuno@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative dark:bg-zinc-900 bg-white p-8  ">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d239.90180178892408!2d-70.02403911249998!3d-15.834043258304717!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x915d69bfb375908d%3A0x212e7887b12bdc57!2sEducaci%C3%B3n%20Continua%20UNA!5e0!3m2!1ses!2sca!4v1671314762330!5m2!1ses!2sca"
                        ...
                        {{-- <form>
                                        <div class="mb-6">
                                            <input type="text" placeholder="Nombres"
                                                class="dark:bg-zinc-900 bg-white text-body-color border-[f0f0f0] focus:border-sky-500 dark:text-yellow-500 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" />
                                        </div>
                                        <div class="mb-6">
                                        ...
                                        <div class="mb-6">
                                            <textarea rows="6" placeholder="Escriba el mensaje"
                                                class="dark:bg-zinc-900 bg-white text-body-color border-[f0f0f0] focus:border-sky-500 dark:text-yellow-500 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
                                        </div>
                                        <div>
                                            <button type="submit"
                                                class="bg-sky-500 dark:text-yellow-500 border-sky-500  w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                                                Enviar mensaje
                                            </button>
                                        </div>
                                    </form> --}}

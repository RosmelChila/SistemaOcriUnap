            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <span class="text-sky-500 dark:text-teal-500 mb-4 block text-base font-semibold">
                            Información
                        </span>
                        <h2
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                                class="bg-sky-500 dark:text-teal-500 text-sky-500  mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                        ...
                        {{-- <form>
                                        <div class="mb-6">
                                            <input type="text" placeholder="Nombres"
                                                class="dark:bg-zinc-900 bg-white text-body-color border-[f0f0f0] focus:border-sky-500 dark:text-teal-500 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" />
                                        </div>
                                        <div class="mb-6">
                                        ...
                                        <div class="mb-6">
                                            <textarea rows="6" placeholder="Escriba el mensaje"
                                                class="dark:bg-zinc-900 bg-white text-body-color border-[f0f0f0] focus:border-sky-500 dark:text-teal-500 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
                                        </div>
                                        <div>
                                            <button type="submit"
                                                class="bg-sky-500 dark:text-teal-500 border-sky-500  w-full rounded border p-3 text-white transition hover:bg-opacity-90">
                                                Enviar mensaje
                                            </button>
                                        </div>
                                    </form> --}}

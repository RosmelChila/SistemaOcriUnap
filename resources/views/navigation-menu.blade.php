...
>
    ...
    <div class="flex justify-end flex-1 lg:mr-32">
        <div class="relative w-full max-w-xl mr-6 focus-sky:text-purple-500">
            ...
            <input class="h-8 w-full pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-800 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-sky-300 focus:outline-none focus:shadow-outline-sky form-input" type="text" placeholder="Buscar convenio" aria-label="Search" />
        </div>
    </div>

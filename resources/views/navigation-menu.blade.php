<nav aria-label="secondary" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-5">
        ...
        <div class="dropdown dropdown-end">
            <label tabindex="0" class="cursor-pointer indicator-item">
                <div class="indicator">
                    @if (Auth::user()->unreadNotifications->count() != 0)
                        <span
                            class="indicator-item badge badge-primary">{{ Auth::user()->unreadNotifications->count() }}</span>
                    @endif
            ...
            <div tabindex="0" class="dropdown-content menu p-2  bg-white dark:bg-zinc-900 rounded-lg  font-light shadow-sm overflow-y-autO h-80">
            <ul class="w-64" >

    ...
    <div class="flex flex-col min-h-screen font-bunny bg-[url('https://radioondaazul.com/wp-content/uploads/2022/08/Universidad-Nacional-del-Altiplano-Puno.jpg')]" >
      ...
      <div class="container mx-auto grid grid-row w-full rounded-md bg-white dark:bg-zinc-900 p-1 text-zinc-800 dark:text-white">
         <div class="mt-2">
            ...
            <span class="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, laboriosam exercitationem. Quas distinctio perferendis, aperiam obcaecati possimus totam itaque nostrum velit eligendi repellat reprehenderit officiis asperiores quam libero, nisi neque?</span>
            </div>

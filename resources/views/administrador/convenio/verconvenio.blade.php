<x-app-layout>
    ...
    <div class="grid grid-rows-1 dark:bg-gray-900 rounded-lg  p-4">
        <div>
            ...
            <p class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->resolution}}</p>
        </div>
        <div>
            <span class="label-text text-gray-900 dark:text-gray-100">Tìtulo</span>
            <p class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->title}}</p>
        </div>
        <div class="py-4 md:col-span-2">
            <span class="label-text text-gray-900 dark:text-gray-100">Objetivos</span>
            <p class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->objetive}}</p>
        </div>
        <div class="py-4 md:col-span-2">
            <span class="label-text text-gray-900 dark:text-gray-100">Fecha de suscripción</span>
            <span class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->subscription}}</span>
        </div>
        <div class="py-4 md:col-span-2">
            <span class="label-text text-gray-900 dark:text-gray-100">Fecha de expiración</span>
            <span class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->expiration}}</span>
        </div>
        <div class="py-4 md:col-span-2">
            <span class="label-text text-gray-900 dark:text-gray-100">Años de vigencia</span>
            <span class="label-text text-gray-800 dark:text-gray-400">{{$agreement[0]->years}}<span
